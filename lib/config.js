...
// ========================================
const API_VERSION = process.env.API_VERSION || packageJson.version;
const DEFAULT_LOCALE = process.env.DEFAULT_LOCALE || "fr-FR";
const MAX_RETRIES = 3;

// URL de base de l'API pour construire des URLs absolues (utilisé pour les proxies d'images/fichiers)
// Exemples: "http://toys_api:3000", "https://api.snowmanprod.fr"
const API_BASE_URL = process.env.TOY_API_BASE_URL || process.env.API_BASE_URL || null;
...
const TRANSFORMERLAND_SEARCH_URL = "https://www.transformerland.com/show_parent_g12.php";
...
const BGG_MAX_LIMIT = 100;
const BGG_RATE_LIMIT_MS = 1000; // 1 seconde entre requêtes
