/**
 * lib/utils/flaresolverr.js - Module FlareSolverr pour bypass Cloudflare
 * toys_api v1.26.0
 * 
...
async function createFsrSession() {
  ...
  try {
    const res = await fetchViaProxy(FSR_BASE, {
      method: "POST",
...
/**
 * Nettoie la session FlareSolverr si elle existe
 * Utilitaire commun pour tous les providers qui utilisent FSR
 */
async function cleanupFsrSession() {
