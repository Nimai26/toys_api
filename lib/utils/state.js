 ...
 * @returns {any|null} - Valeur ou null si absente/expirée
 */
...
/**
 * Middleware Express pour ajouter les headers Cache-Control
 */
export function addCacheHeaders(res, maxAge = 300) {
