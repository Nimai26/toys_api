...
export function normalizeBGGDetail(raw, options = {}) {
  ...
  const manuals = (raw.manuals || []).map(m => ({
    ...
    downloadUrlProxy: m.downloadUrlProxy,
    isRules: m.isRules,
    thumbs: m.thumbs
  }));
  ...
  return {
    ...
    instructions: {
      ...
      bestManual: raw.bestManual ? {
        ...
        url: raw.bestManual.url,
        urlProxy: raw.bestManual.urlProxy,
        downloadUrl: raw.bestManual.downloadUrl,
        downloadUrlProxy: raw.bestManual.downloadUrlProxy
      } : null,
      manuals
    },
    ...
    images: {
      primary: raw.image,
      primaryProxy: raw.imageProxy,
      thumbnail: raw.image, // BGG n'a pas de thumbnail séparé
      thumbnailProxy: raw.imageProxy,
      box_front: null,
      box_back: null,
      gallery: []
    },
