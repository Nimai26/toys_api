    ...
    if (autoTrad && lang !== 'en') {
      ...
      if (result.categories && result.categories.length > 0) {
        try {
          ...
          if (catResult && catResult.translated) {
            result.categoriesOriginal = result.categories;
      ...
      if (result.mechanics && result.mechanics.length > 0) {
        try {
          ...
          if (mechResult && mechResult.translated) {
            result.mechanicsOriginal = result.mechanics;
