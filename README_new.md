...
- 🔍 Multi-source product search (LEGO, Mega Construx, Rebrickable, Google Books, OpenLibrary, RAWG, IGDB, TVDB, TMDB, IMDB, Jikan, Coleka, Lulu-Berlu, Transformerland, Paninimania)
...
```bash
GET /lego/search?q=millennium+falcon&lang=fr-FR
```
  ...
  "books": [
    {
      ...
      "isbn10": "2070584623",
      "isbn13": "9782070584628",
      "pageCount": 320,
      "categories": ["Juvenile Fiction"],
      "language": "fr",
      "thumbnail": "https://books.google.com/...",
      "previewLink": "https://books.google.fr/books?id=...",
      "infoLink": "https://books.google.fr/books?id=..."
    }
  ]
}
```
...
Retourne des informations détaillées incluant : storyline, screenshots, artworks, vidéos YouTube, sites web, jeux similaires, DLCs, franchises, classifications PEGI/ESRB.
...
Recherche de jeux vidéo sur JeuxVideo.com (en français uniquement).
...
Retourne : titre, description, date de sortie, plateformes, note, genre, éditeur, développeur.
...
##### Search Products
```bash
GET /lego/search?q=millennium+falcon&lang=en-US
```
